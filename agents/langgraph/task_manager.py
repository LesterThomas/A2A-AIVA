...
class AgentTaskManager(InMemoryTaskManager):
    def __init__(
        self, agent: AIVAAgent, notification_sender_auth: PushNotificationSenderAuth
    ):
        super().__init__()
        self.agent = agent
        self.notification_sender_auth = notification_sender_auth
        print("--------------------------------")
        print(f"AgentTaskManager initialized with agent: {agent}")

    async def _run_streaming_agent(self, request: SendTaskStreamingRequest):
        print("--------------------------------")
        print(f"Running streaming agent for request: {request}")
    ...
    def _validate_request(
        ...
        if not utils.are_modalities_compatible(
            task_send_params.acceptedOutputModes, AIVAAgent.SUPPORTED_CONTENT_TYPES
        ):
            logger.warning(
                "Unsupported output mode. Received %s, Support %s",
                task_send_params.acceptedOutputModes,
                AIVAAgent.SUPPORTED_CONTENT_TYPES,
            )
    ...
    async def on_send_task(self, request: SendTaskRequest) -> SendTaskResponse:
        ...
        print("--------------------------------")
        print(f"Handling send task request: {request}")
    ...
    async def on_send_task_subscribe(
        ...
        print("--------------------------------")
        print(f"Handling send task subscribe request: {request}")
        try:
    ...
    async def _process_agent_response(
        ...
        print("--------------------------------")
        print(f"Processing agent response: {agent_response}")
        task_send_params: TaskSendParams = request.params
    ...
    def _get_user_query(self, task_send_params: TaskSendParams) -> str:
        print("--------------------------------")
        print(f"Getting user query from task send params: {task_send_params}")
    ...
    async def send_task_notification(self, task: Task):
        print("--------------------------------")
        print(f"Sending task notification for task: {task}")
    ...
    async def on_resubscribe_to_task(
        ...
        print("--------------------------------")
        print(f"Handling resubscribe to task request: {request}")
    ...
    async def set_push_notification_info(
        ...
        print("--------------------------------")
        print(
            f"Setting push notification info for task {task_id} with config: {push_notification_config}"
        )
